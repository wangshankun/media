...
#define FFMPEG_CONFIGURATION "--enable-libmfx --enable-nonfree --enable-shared --enable-pic --enable-gpl --prefix=/root/ffmpeg --extra-cflags=-fPIC --extra-ldflags=-L/opt/intel/mediasdk/lib64 --extra-libs='-lpthread -lm -lmfx' --enable-encoder=h264_qsv --enable-decoder=h264_qsv"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/root/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/root/ffmpeg/share/ffmpeg"
#define CC_IDENT "gcc 5.5.0 (Ubuntu 5.5.0-12ubuntu1~16.04) 20171010"
